...
<head>
    <meta charset="utf-8">
    <title>Brochure UnicoCompliance - Sollecito 7 giorni</title>
    <style>
        ...
        .btn { display: inline-block; padding: 12px 30px; background-color: #d97706; color: #ffffff !important; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; transition: background-color 0.2s; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Circa una settimana fa ti abbiamo inviato un link per accedere alla tua brochure personalizzata di UnicoCompliance.</p>
            <p>Volevamo assicurarci che tu avessi ricevuto correttamente il link e invitarti a visionare le soluzioni su misura che abbiamo preparato per te.</p>
            
            <div class="btn-wrapper">
                <a href="{{ $url }}" class="btn">Visualizza la tua Brochure</a>
            </div>
